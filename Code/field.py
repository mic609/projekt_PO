...
class Field:
    ...
    __fresh = True  # atrybut informujacy czy kratki dopiero co powstaja, potrzebny do uwzglednienia maksymalnej
    # liczby obiektow znajdujacych sie w kratce
    __amount = 0
    ...
    def __init__(self, xcord, ycord):
        self.__xcord = xcord
        self.__ycord = ycord
        # self.__number_of_all = number_of_all
        self.__status = [0, 0, 0, 0, 0, 0, 0, 0]  # zmienna przechowujaca status obiektu,
        # pierwsza cyfra - liczba obiektow na kratce
    ...
    def change_obj_amount(self, sign, type, ID): # Kazdy obiekt ma swoj ID - indeks
        ...
        # sign zawiera informację o tym czy zwiększyć czy zmniejszyć, type to nowy atrubut, ktory bedzie zawieral
        # kazdy obiekt na planszy i bedzie ew. atrybutem identyfikujacym obiekt
        # (kratka musi wiedziec jaki obiekt na nia wchodzi)
